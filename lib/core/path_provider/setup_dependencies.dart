...
import 'data/repositories/json_path_provider_impl.dart';
...
void setupPathProviderDependencies() {
  ...
  sl.registerLazySingleton<AppPathProvider>(
      () => AppPathProviderImpl(sl<AppPathProviderDataSource>()));
  sl.registerLazySingleton<JsonPathProvider>(
      () => JsonPathProviderImpl(sl<AppPathProvider>()));
}
