...
class ReaderSendPreviousPageUseCase extends UseCase<void, void> {
  ReaderSendPreviousPageUseCase(this._repository);

  final ReaderWebViewRepository _repository;

  @override
  void call([void parameter]) {
    _repository.send(const ReaderWebMessageDto(route: 'prevPage'));
  }
}
