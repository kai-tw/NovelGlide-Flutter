      ...
      child: Semantics(
        ...
        child: BlocBuilder<CollectionListCubit, CollectionListState>(
          buildWhen: (CollectionListState previous, CollectionListState current) =>
              ...
              previous.selectedSet.contains(collectionData) != current.selectedSet.contains(collectionData) ||
          ...
          builder: (BuildContext context, CollectionListState state) {
            return CollectionListDraggableCollection(
              ...
              isDraggable: state.code.isLoaded && !state.isSelecting && !state.isDragging,
