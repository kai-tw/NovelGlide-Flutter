...
class ExploreBrowserState extends Equatable {
  const ExploreBrowserState({
  ...
  ExploreBrowserState copyWithFavoriteIdentifier(String? favoriteIdentifier) {
    return ExploreBrowserState(
      code: code,
      catalogFeed: catalogFeed,
