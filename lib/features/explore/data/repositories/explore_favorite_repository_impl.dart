...
class ExploreFavoriteRepositoryImpl implements ExploreFavoriteRepository {
  ExploreFavoriteRepositoryImpl(this._dataSource);

  final ExploreFavoriteDataSource _dataSource;
